...
function Home() {
  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="https://shoaibakhtar00.github.io/Shoaib-portfolio/" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span className="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">Unveil</span> <span className="text-sm font-medium"> My Portfolio of Creations</span> 
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a href="/demo.mp4" target="_blank" rel="noopener noreferrer" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800 hover:cursor-pointer">
  ...
  <h1 className="mb-4 text-xl font-bold tracking-tight text-gray-900 dark:text-white md:text-2xl lg:text-3xl">
    Get hired by top companies:
  </h1>

  <svg viewBox="0 0 1200 100" width="1200" height="100" xmlns="http://www.w3.org/2000/svg">
    <g id="logoGroup">
      <image
        x="1200"
        y="20"
        ...
        alt="Google"
        style={{ filter: 'invert(0) grayscale(100%) brightness(0) contrast(100%)' }}
      />
      <image
        x="1400"
        y="20"
      ...
      <image
        ...
        width="100"
        height="60"
        href="https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg"
        alt="Microsoft"
        style={{ filter: 'invert(0) grayscale(100%) ' }}
      />
      <image
        x="1650"
        y="20"
      ...
      <image
        ...
        width="100"
        height="60"
        href="https://upload.wikimedia.org/wikipedia/commons/5/51/IBM_logo.svg"
        alt="IBM"
        style={{ filter: 'invert(0) grayscale(100%) brightness(0) contrast(100%)' }}
      />
      <image
        ...
        width="70"
        height="60"
        href="https://upload.wikimedia.org/wikipedia/commons/b/bb/Tesla_T_symbol.svg"
        alt="Tesla"
        style={{ filter: 'invert(0) grayscale(100%) brightness(0) contrast(100%)' }}
      />
      <image
...
<h2 className="text-md text-gray-500">Discover Extraordinary Features,
Unveil the Best of Innovation.</h2>
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <AtomIcon className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">AI-Powered Suggestions</h2>

        <p className="mt-1 text-sm text-gray-600">
        Unlock the Power of AI to Refine Your Resume,
        Tailoring Every Detail for Maximum Impact.
        Experience Smart Suggestions for Career Excellence.
        </p>
      </a>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Effortless Updates </h2>

        <p className="mt-1 text-sm text-gray-600">
        Effortlessly enhance your resume with a sleek, intuitive editor.
        Make updates on the fly, anytime you desire.
        Your professional profile, always polished and up-to-date.
        </p>
      </a>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Download & Share Your Resume with Ease</h2>

        <p className="mt-1 text-sm text-gray-600">
        Download Your Refined Resume,
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Shoaib Akhtar</h2>

        <svg viewBox="0 0 200 40" width="200" height="40" xmlns="http://www.w3.org/2000/svg">
    {/* Line that grows and shrinks */}
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      {/* Animation to grow and shrink the line */}
      <animate 
        attributeName="x2" 
        values="10; 190; 10" 
        dur="3s" 
      ...
      />
        ...
        <p className="mt-1 text-sm text-gray-600">
        The resume builder made editing a breeze. With intuitive design and seamless AI assistance, I crafted a standout resume effortlessly. Downloading and sharing my resume was quick and straightforward—perfect for any job seeker!
        </p>
      </a>
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Abhinov Roy </h2>
    ...
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      ...
      />
        ...
        <p className="mt-1 text-sm text-gray-600">
        I was amazed by how easy it was to update my resume using this tool. The AI-driven suggestions were spot-on and truly helped refine my content. Plus, the download and sharing features made distribution a snap!
        </p>
      </a>
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Rahul Nonia</h2>
    ...
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      ...
      />
        ...
        <p className="mt-1 text-sm text-gray-600">
        This resume builder is a game-changer! The editing process is incredibly intuitive, and the AI support provided excellent tips for improvement. Downloading and sharing my resume was seamless, making my job search a lot smoother.
        </p>
      </a>
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Farhan Nazir</h2>
    ...
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      ...
      />
        ...
        <p className="mt-1 text-sm text-gray-600">
        Editing my resume was a joy with this platform—simple and user-friendly. The AI enhancements took my resume to the next level, and sharing it with potential employers was as easy as clicking a button. Highly recommend!
        </p>
      </a>
  ...
  <footer className="bg-gray-800 text-white text-center py-4 mt-8">
      <div className="container mx-auto">
        <p className="mb-2">© 2024 ResumeBuilder. All Rights Reserved.</p>
        <p className="mb-2">
          <a href="/privacypolicy" className="text-blue-400 hover:underline">Privacy Policy</a> | 
          <a href="/terms-of-service" className="text-blue-400 hover:underline"> Terms of Service</a>
        </p>
        <p>
          Designed with <span role="img" aria-label="heart" className="text-red-500">❤️</span> by Shoaib Akhtar
        </p>
      </div>
    </footer>
